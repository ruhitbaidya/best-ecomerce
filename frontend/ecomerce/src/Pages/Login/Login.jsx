        ...
        <div className="grid grid-cols-2 gap-[25px]">
          <div>
            ...
            <div className="flex justify-center items-center gap-[25px] mt-[20px]">
              <button onClick={handelGoogleLogin} className="flex px-[45px] py-[15px] googlebg justify-center items-center gap-[15px]">
                <img
                  className="w-4 h-4"
            ...
            <div className="divider text-[#5C635A] my-[20px] w-[73%] mx-auto">
