  ...
  return (
    <div className="mt-[20px] lg:flex items-center gap-[25px]">
      <div className="flex-1">
        ...
        <div className="mt-[20px] bg-white py-[50px] rounded-lg">
      ...
      <div className="flex-1">
        ...
        <div className="bg-white p-[20px] mt-[20px] rounded-lg">
            <div className="grid grid-cols-1  lg:grid-cols-3  text-center ">
              {
                cityName?.map((item)=> <p key={item.id} className="row-item text-[#156BCA] border-b-2 p-[15px]"><Link to="">{item.cityName}</Link></p>)
              }
